...
class TradingAgentResponse(BaseModel):
    ...
    capital_allocation: int = Field(description="The percentage of the available capital (USDC in your wallet) to allocate to the token. It is a number between 0 and 100.", default=0)
